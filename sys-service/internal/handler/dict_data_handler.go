...
// @Router       /api/sys/v1/dict/data/list [get]
...
// @Success      200      {object}  response.Response
// @Router       /api/sys/v1/dict/data [post]
...
// @Success      200      {object}  response.Response
// @Router       /api/sys/v1/dict/data/{id} [put]
...
// @Success      200  {object}  response.Response
// @Router       /api/sys/v1/dict/type/{id} [get]
...
// @Security     BearerAuth
// @Success      200  {object}  response.Response
// @Router       /api/sys/v1/dict/refresh-cache [delete]
...
// @Param        id   path      int  true  "字典数据ID"
// @Success      200  {object}  response.Response
// @Router       /api/sys/v1/dict/data/{id} [get]
...
// @Success      200   {object}  response.Response
// @Router       /api/sys/v1/dict/data/{ids} [delete]
...
// @Success      200      {object}  response.Response
// @Router       /api/sys/v1/dict/data/sort [put]
