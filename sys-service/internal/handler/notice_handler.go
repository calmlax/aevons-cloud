...
// @Router       /api/sys/v1/notice/list [get]
...
// @Security     BearerAuth
// @Success      200  {object}  response.Response
// @Router       /api/sys/v1/notice/page [get]
...
// @Success      200  {object}  response.Response
// @Router       /api/sys/v1/notice/{id} [get]
...
// @Success      200      {object}  response.Response
// @Router       /api/sys/v1/notice/{id} [put]
...
// @Success      200   {object}  response.Response
// @Router       /api/sys/v1/notice/{ids} [delete]
