...
// @Router       /api/sys/v1/lang/list [get]
...
// @Security     BearerAuth
// @Success      200  {object}  response.Response
// @Router       /api/sys/v1/lang/page [get]
...
// @Success      200   {object}  response.Response
// @Router       /api/sys/v1/lang/{ids} [delete]
