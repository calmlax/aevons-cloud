...
// @Router       /api/sys/v1/dict/list [get]
...
// @Security     BearerAuth
// @Success      200  {object}  response.Response
// @Router       /api/sys/v1/dict/page [get]
...
// @Param        id   path      int  true  "字典类型ID"
// @Success      200  {object}  response.Response
// @Router       /api/sys/v1/dict/{id} [delete]
