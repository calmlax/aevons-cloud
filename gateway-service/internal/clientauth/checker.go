...
func NewChecker(enabled bool, db *gorm.DB, refreshEvery time.Duration) *Checker {
	...
	return &Checker{
		...
		cacheKey:       "gateway-service:oauth-client-rules:v1",
		backupCacheKey: "gateway-service:oauth-client-rules:backup:v1",
		lockKey:        "gateway-service:oauth-client-rules:lock:v1",
