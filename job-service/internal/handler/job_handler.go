...
// @Param        id   path      int  true  "定时任务ID"
// @Success      200  {object}  response.Response
// @Router       /api/job/v1/{id}/trigger [post]
...
// @Success      200      {object}  response.Response
// @Router       /api/job/v1/{id}/status [put]
