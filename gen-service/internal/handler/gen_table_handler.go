...
// @Router       /api/gen/v1/table/list [get]
...
// @Security     BearerAuth
// @Success      200  {object}  response.Response
// @Router       /api/gen/v1/table/page [get]
...
// @Success      200  {object}  response.Response
// @Router       /api/gen/v1/table/{id} [get]
...
// @Success      200      {object}  response.Response
// @Router       /api/gen/v1/table/{id} [put]
...
// @Success      200   {object}  response.Response
// @Router       /api/gen/v1/table/{ids} [delete]
...
// @Security     BearerAuth
// @Success      200  {object}  response.Response
// @Router       /api/gen/v1/table/db [get]
...
// @Success      200      {object}  response.Response
// @Router       /api/gen/v1/table/import [post]
...
// @Success      200      {object}  response.Response
// @Router       /api/gen/v1/table/synch [get]
...
// @Param        tableId  query     int  true  "代码生成表ID"
// @Success      200      {object}  response.Response
// @Router       /api/gen/v1/table/preview [get]
...
// @Router       /api/gen/v1/table/download [get]
